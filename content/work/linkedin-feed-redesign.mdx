...
seoTitle: "A UX Audit and Redesign of LinkedIn's Feed"
...
description: "A self-initiated audit and redesign of LinkedIn's homepage feed, built to prove that hierarchy and accessibility are decisions, not decoration."
...
faqs:
  - question: "Why redesign a product you don't work on, with no client brief?"
    answer: "It's a page every reviewer already uses, so the reasoning can be judged against something real instead of taken on my word. It also let me run the audit and redesign without a client's constraints, useful for showing process end to end."
  - question: "What was the one root cause behind fourteen separate issues?"
    answer: "Nothing on the page had a rule for what deserved visual weight, so a puzzle widget, an ad, and the content a user actually came for competed on equal footing. Auditing against real WCAG criteria showed most of the hierarchy and accessibility problems were the same failure wearing different clothes."
  - question: "How were the results validated, since this wasn't a production launch?"
    answer: "A moderated, within-subjects usability test: the same 5 peers, the same four tasks on both versions, order randomized to control for learning effects, plus a post-task ease rating. Not production analytics, but real timed tasks and real feedback rather than just my own judgment."
  - question: "Isn't a 5-person test too small to trust?"
    answer: "Yes, as a sample it's directional, not statistically significant. I treat it that way in the write-up: it's real signal on task success, time-on-task, and error rate, not proof the redesign would perform the same at LinkedIn's scale."
---
...
<MediaFigure
  src="/images/work/linkedin/the-problems.webp"
...
<MediaFigure
  src="/images/work/linkedin/discovery-and-learnings.webp"
...
That pattern held across all fourteen findings I catalogued, from smaller interaction issues (weak feed-sort prominence, unexplained network suggestions, inconsistent icon treatments, ambiguous engagement totals) to structural issues such as the fragmented three-column layout, redundant profile summary, overloaded navigation row, and disappearing secondary content. They were not fourteen unrelated defects; they were recurring examples of the page lacking a consistent rule for what deserved attention.

## Defining the Real Problem

That reframed the project. I'd started this framed as "clean up the visual noise." After the audit, I reframed it as <mark>"give the page one consistent rule for what earns visual weight, using accessibility criteria as the mechanism for deciding that, not a checklist applied after the layout is done."</mark>
...
<MediaFigure
  src="/images/work/linkedin/linkedin-exploring-solutions.webp"
  alt="Sketches comparing lighter-touch alternatives considered for the LinkedIn feed redesign against the structural fixes ultimately chosen — a contrast-only nav fix, a divider-only profile card fix, and higher-contrast icon-only reactions"
  caption="Lighter-touch alternatives considered and ruled out for the navigation row, profile card, and reaction controls, before committing to the four structural decisions below."
/>

**The overloaded nav row** (an [**information architecture**](/ux-ui-designer-nepal) problem) crammed platform utilities (search, notifications, profile) and page destinations (Home, Jobs, Messaging) into one line at equal weight. The lighter fix, raising icon contrast in place, wouldn't have fixed the real problem: two different questions competing for one visual treatment.
...
<MediaFigure
  src="/images/work/linkedin/linkedin-design-decision-01-navigation.webp"
  alt="Before and after comparison of the LinkedIn navigation bar: the original single row mixing platform utilities and page destinations at equal visual weight, versus the redesigned two-row navigation with a clear blue active state for Home"
  caption="Before and after: one overloaded navigation row split into a utility row and a page-destination row, with a legible blue active state replacing the previous gray-on-gray treatment."
/>
...
<MediaFigure
  src="/images/work/linkedin/linkedin-design-decision-02-profile-metrics.webp"
  alt="Before and after comparison of the LinkedIn sidebar: the original profile card with redundant identity info and low-frequency metrics sitting beside the Premium promotion, versus the redesigned sidebar with the profile summary removed and the Premium promotion relocated to its own right-rail card"
  caption="Before and after: the redundant profile summary and low-frequency metrics removed from the feed, with the Premium promotion relocated to a clearly separate right-rail card."
/>
...
<MediaFigure
  src="/images/work/linkedin/linkedin-design-decision-03-two-column-system.webp"
  alt="Before and after comparison of the LinkedIn homepage layout: the original three-column grid with no shared structure, versus the redesigned two-column layout with a persistent sticky right rail"
  caption="Before and after: three independent columns collapsed into one two-column system, with a sticky right rail that stays visible while scrolling."
/>
...
<MediaFigure
  src="/images/work/linkedin/linkedin-design-decision-04-visible-action-labels.webp"
  alt="Before and after comparison of LinkedIn post engagement controls: the original icon-only Like, Comment, Share, and Save buttons with bare reaction numbers, versus the redesigned controls with visible text labels and spelled-out counts like '42 reactions · 12 comments'"
  caption="Before and after: icon-only engagement controls and bare reaction counts replaced with visible text labels and explicit, screen-reader-friendly counts."
/>
...
<MediaFigure
  src="/images/work/linkedin/linkedin-validation-before-after-test.webp"
  alt="Summary chart of the before/after usability test results across five tasks, showing improvements in time-on-task, task success rate, error rate, and post-task ease rating between the original and redesigned LinkedIn feed"
  caption="Before/after usability test results across five tasks: faster navigation orientation, higher task success, fewer Premium-promotion misreads, and a higher ease-of-use rating for the redesigned feed."
/>
...
| "Easy to tell what matters on this page" (1 to 5)                        | [Single Ease Question](https://measuringu.com/seq10/)                                              | avg 2.4                       | avg 4.2                       |
...
<MediaCarousel
  images={[
    {
      src: "/images/work/linkedin/linkedin-dark.webp",
      alt: "Final redesigned LinkedIn homepage feed shown in dark mode, with the split navigation, two-column layout, sticky right rail, and labeled engagement actions",
      caption: "The redesigned feed in dark mode.",
    },
    {
      src: "/images/work/linkedin/linkedin-light.webp",
      alt: "Final redesigned LinkedIn homepage feed shown in light mode, with the split navigation, two-column layout, sticky right rail, and labeled engagement actions",
      caption: "The redesigned feed in light mode.",
    },
  ]}
/>
