...
seoTitle: "Redesigning Onboarding to Cut Signup Drop-off"
client: "Pagevamp"
...
faqs:
  - question: "What was actually causing the drop-off before the redesign?"
    answer: "Not missing features. Domain choice, content review, and the privacy conversation were all pushed to the end of the flow, after users had already invested time. It was a sequencing and inclusion problem, not a features problem."
  - question: "Why did privacy concerns drop from 15% to under 5%?"
    answer: "Privacy was surfaced early and explained in context instead of appearing as a late, unexplained ask. Users who understood what was being requested and why were far less likely to bail at that step."
  - question: "The one-click pitch was the product's whole value. How did you add steps without undermining it?"
    answer: "By prefilling everything the product already had access to instead of asking users to re-enter it. The fix was asking for the right things once, upfront, not adding more configuration."
  - question: "Who was the 20% of trial users the product previously had no path for?"
    answer: "People without a Facebook Page to import from, a fifth of the trial funnel treated as an edge case rather than a real segment. Competitive analysis showed an absent domain step made Pagevamp look less capable than alternatives at exactly the moment users were deciding whether to trust it."
---

## Overview

Pagevamp turns a business's Facebook Page into a live, synced website in one click. <mark>It's a great pitch, but the onboarding flow built to deliver on it worked against the product's core promise.</mark>
...
- **Scope:** Solo [UX design](/ux-ui-designer-nepal) project: a two-week research sprint followed by a full onboarding redesign, with cross-functional input from engineering and support
...
Pagevamp's entire pitch is speed: point it at a Facebook Page and it builds a real, synced website in one click, with no coding, no blank page, and no manual content migration. For small business owners, freelancers, and organizations with no time or technical background, that speed *is* the product.
...
<MediaFigure
  src="/images/work/pagevamp/funnel-drop-off.webp"
...
<MediaFigure
  src="/images/work/pagevamp/persona-summary.webp"
...
This wasn't a missing-features problem. <mark>It was a sequencing and inclusion problem.</mark>
...
<MediaCarousel
  images={[
    {
      src: "/images/work/pagevamp/privacy-concern-before.webp",
    ...
    {
      src: "/images/work/pagevamp/privacy-concern-after.webp",
...
<MediaFigure
  src="/images/work/pagevamp/create-facebook-page.webp"
...
<MediaFigure
  src="/images/work/pagevamp/review-website-details.webp"
...
<MediaCarousel
  images={[
    {
      src: "/images/work/pagevamp/domain-setup-buy.webp",
    ...
    {
      src: "/images/work/pagevamp/domain-setup-subdomain.webp",
    ...
    {
      src: "/images/work/pagevamp/domain-setup-owndomain.webp",
...
<MediaFigure
  src="/images/work/pagevamp/process-iteration.webp"
...
<MediaFigure
  src="/images/work/pagevamp/outcome.webp"
