---
title: "Pagevamp: Fixing the First Five Minutes"
client: "Pagevamp"
...
description: "Redesigning onboarding for a one-click website builder so trial users actually finish setting up, and building a real path for the segment the product had no answer for."
...
<CaseStudyImage
  ...
  alt="Funnel diagram showing where each user segment stalled in the original onboarding flow"
...
<CaseStudyImage
  ...
  alt="Competitive analysis matrix comparing domain step placement and onboarding complexity"
