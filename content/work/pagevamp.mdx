...
<CaseStudyImage
  src="https://placehold.co/1200x600/EFF6FF/1D4ED8?text=Facebook+Page+%E2%86%92+Live+Website+in+One+Click&font=montserrat"
  alt="Pagevamp concept: Facebook Page on the left, generated website on the right"
  caption="Pagevamp's core promise: point it at a Facebook Page and it builds a real, synced website instantly."
/>
...
<CaseStudyImage
  src="https://placehold.co/1200x500/FFF7ED/C2410C?text=Funnel+Drop-off+by+Segment&font=montserrat"
...
<CaseStudyImage
  src="https://placehold.co/1200x500/F0FDF4/166534?text=User+Personas%3A+David+%26+Sarah&font=montserrat"
...
<CaseStudyImage
  src="https://placehold.co/1200x500/F5F3FF/6D28D9?text=Competitive+Analysis+Matrix&font=montserrat"
...
<CaseStudyImage
  src="https://placehold.co/1200x500/EFF6FF/1D4ED8?text=Old+Flow+vs+New+Flow&font=montserrat"
  alt="Side-by-side diagram of the original onboarding flow versus the redesigned flow"
  caption="Same decisions, different order. Moving domain, privacy, and content review earlier reduced abandonment at each step."
/>
...
### 1. Prefill from Facebook, Don't Re-ask
...
### 2. Move Domain Selection into Setup, Not Settings
...
### 3. Make the Privacy Conversation Explicit and Early
...
### 4. Build a Path for Users Without a Facebook Page
...
<CaseStudyImage
  src="https://placehold.co/1200x600/EFF6FF/1D4ED8?text=Prefill+%7C+Domain+Step+%7C+Privacy+Disclosure&font=montserrat"
  alt="Final UI screens showing the prefill review step, domain selection step, and privacy disclosure"
  caption="The three key screens that changed the most: content review (prefilled from Facebook), domain selection (moved to setup), and privacy disclosure (explicit, early)."
/>
...
<CaseStudyImage
  src="https://placehold.co/1200x500/FAFAF9/44403C?text=Sketches+%E2%86%92+Prototype&font=montserrat"
...
<mark>The redesign also surfaced a clearer picture of what to build next.</mark> Requests for ecommerce support, new templates, a single-page option, and Instagram account support all came in post-launch. A reasonable sign that onboarding was no longer the thing standing between users and the rest of the product.
