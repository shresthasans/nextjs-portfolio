...
<SeriesNav
  ...
  currentPart={2}
  totalParts={5}
  prev={{ title: "User Research", href: "/blog/user-research-applied" }}
  next={{ title: "Design Process", href: "/blog/design-process-applied" }}
/>
