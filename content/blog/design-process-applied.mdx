...
excerpt: "A strong process brings structure to messy problems. Here's how flows, IA, prioritization, and critique work together to guide real decisions."
...
<SeriesNav
  ...
  currentPart={3}
  totalParts={5}
  prev={{ title: "Product Thinking", href: "/blog/product-thinking-applied" }}
  next={{ title: "Design Systems", href: "/blog/design-systems-applied" }}
/>
